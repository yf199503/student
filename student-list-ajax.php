...
function renderList(datalist){
	...
	for (var i = 0; i < datalist.length; i++) {
		...
		str += "<tr><td>"+ datalist[i].id+"</td><td>"+ datalist[i].学号+"</td><td>"+ datalist[i].姓名+"</td><td>"+ datalist[i].性别+"</td><td>"+ datalist[i].出生日期+"</td><td>"+ datalist[i].电话+"</td><td><a class='sui-btn btn-samll btn-warning' href='student-update.php?sid="+datalist[i].学号+"'>修改</a>&nbsp;&nbsp;<a class='sui-btn btn-samll btn-danger' href='student-del.php?sid="+datalist[i].学号+"'>删除</a></td></tr>";
	}
